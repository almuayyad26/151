...
<div class="row d-flex align-items-center">
    <div class="col-3 text-right">
        <i class="far fa-user text-warning display-4"></i>
    </div>
    <div class="col-4 text-center text-black">
        <h2 class="text-warning d-block display-4 counter userStatusPieChartCard_totalCount"><b>0</b></h2>
    </div>
                ...
                series: [
                    {
                        ...
                        name: '${labels['page.home.KunjunganRalan']}',
                        type: 'pie',
                        radius: '85%',
